(function () {
    ...
    const audio = new Audio("yungkai.mp3"); // Use a new Audio instance
...
let btnFirework = document.getElementsByClassName("btn-firework");
btnFirework.style.textalign = "center";
btnFirework.style.margin = "auto";